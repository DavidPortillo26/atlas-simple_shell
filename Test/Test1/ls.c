...
void lsal_command()
{
    /* Similar to lsl_command() but includes hidden files/directories */
}

/* Function to check ls command options and execute corresponding functions */
void check_ls()
{
    /* Check if no ls options specified */
    /* Execute ls_command() and set execFlag to indicate successful execution */
    /* Continue similar checks for other ls options and execute corresponding functions */
}